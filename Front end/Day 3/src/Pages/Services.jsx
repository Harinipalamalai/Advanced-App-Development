...
function Services() {
  return (
    ...
    <div className="about-me">
      <div className='event1'><img src="https://img.freepik.com/free-photo/tractor-field-ai-generated-image_268835-6450.jpg?t=st=1706292829~exp=1706296429~hmac=e34568904fa38810b992d7b75551c7421a8b195e7247ea43d62f70b432b0983a&w=1800" alt="me"></img><p className='para'>Agriculture land loans are specifically intended for the purchase, development of agricultural land.The loan amount depends on factors such as the value of the land.</p><button className='button-33'>APPLY NOW</button></div>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <div className='event2'><img src="https://img.freepik.com/free-photo/plant-growing-soil-with-sun-shining-it_1340-38891.jpg?size=626&ext=jpg&ga=GA1.1.627563915.1683457253&semt=ais_ai_generated" alt="me"></img><p className='para'>A tractor loan is a type of financing specifically designed to assist individuals, farmers, or businesses in purchasing tractors and related agricultural equipment.</p><button className='button-33'>APPLY NOW</button>
      </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
